...
<head> 
    ...
    @stack('css')
    <title>Login - Seleksi pengibar bendera</title>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center form-bg-image" data-background-lg="{{ asset('img/illustrations/signin.svg') }}">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500" style="height: 600px">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-5 h3">Sign in to our platform</h1>
                                @error('email')
                            ...
                            <form method="POST" action="{{ route('login') }}" class="mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email" class="form-control" placeholder="example@seleksipengibar.online" id="email" autofocus required>
                                    </div>  
                                </div>
